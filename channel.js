...
var Favicon_URL = 'https://cdn.jsdelivr.net/gh/ShizuruAnon/December_Testing/Images/tiger.png';
...
//Team Colour
$('head').append('<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/ShizuruAnon/December_Testing/teamcolor.js">');
...
class CustomTextTriggers {
	static init() {
		...
		CustomTextTriggers.padoru_images = [
			// Yue
			'https://cdn.jsdelivr.net/gh/ShizuruAnon/December_Testing/Images/yue-padoru.png',
			// Saber
			'https://cdn.jsdelivr.net/gh/ShizuruAnon/December_Testing/Images/saber-padoru.png',
			// Chino
			'https://cdn.jsdelivr.net/gh/ShizuruAnon/December_Testing/Images/chino-padoru.png',
			// Taiga
			'https://cdn.jsdelivr.net/gh/ShizuruAnon/December_Testing/Images/taiga-padoru.png',
			// Miku
			'https://cdn.jsdelivr.net/gh/ShizuruAnon/December_Testing/Images/miku-padoru.png',
			// Shizuru
			'https://cdn.jsdelivr.net/gh/ShizuruAnon/December_Testing/Images/shizu_padoru.png',
		];
